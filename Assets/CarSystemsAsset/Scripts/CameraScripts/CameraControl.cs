...
public class CameraControl : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        oldZ = car.transform.transform.rotation.eulerAngles.y;
        m_Car = car.GetComponent<CarControl>();
        target = car.FindChild("camToLookAt");
        _camera = GameObject.FindWithTag("CarCam").GetComponent<Camera>();
    }
    ...
    void inRaceMove()
    {
        ...
        wantedHeight = car.transform.position.y + height;
        wantedX = car.transform.position.x;
